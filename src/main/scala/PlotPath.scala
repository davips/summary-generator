...
object PlotPath extends App {
  ...
  val rows = Seq("4617840", "4996869")
  val file1c = "f5-0-7x7-100-1c-999999.on.log"
  ...
  val res = lines1c flatMap {
    case (stour: String) :: (spoints: String) :: (tail: List[String]) if rows.contains(tail.dropRight(1).last) =>
      ...
      Some(trip)
    case _ => None //throw new Error("unexpected!")
  }
