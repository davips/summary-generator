...
object PlotPath extends App {
  ...
  val rows = Seq("10120", "27707034", "51360916")
  val allMode = !true
  val file1c = "f5-0-4x4-100-1c-999999.on.5000.log"
  ...
  if (res.length < 2) throw new Error(s"At least one timestamp ${rows.mkString(";")} not found!")
